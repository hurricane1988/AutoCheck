...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.groupBoxProperty = QtWidgets.QGroupBox(self.mainWindows)
        self.groupBoxProperty.setGeometry(QtCore.QRect(20, 20, 1051, 281))
        font = QtGui.QFont()
        font.setFamily("华文中宋")
        font.setPointSize(11)
        font.setBold(True)
        font.setWeight(75)
        self.groupBoxProperty.setFont(font)
        self.groupBoxProperty.setStyleSheet("color: rgb(85, 85, 127);")
        self.groupBoxProperty.setAlignment(QtCore.Qt.AlignCenter)
        self.groupBoxProperty.setFlat(False)
        self.groupBoxProperty.setObjectName("groupBoxProperty")
        self.treeView = QtWidgets.QTreeView(self.groupBoxProperty)
        self.treeView.setGeometry(QtCore.QRect(10, 20, 1031, 251))
        self.treeView.setObjectName("treeView")
        self.groupBoxGraph = QtWidgets.QGroupBox(self.mainWindows)
        self.groupBoxGraph.setGeometry(QtCore.QRect(20, 310, 1051, 311))
        font = QtGui.QFont()
        font.setFamily("华文中宋")
