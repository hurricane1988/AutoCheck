...
from PyQt5.QtWidgets import QMainWindow,QWidget,QHBoxLayout,QPushButton,QLineEdit,QLabel
from PyQt5.QtWidgets import QSplitter,QApplication,QTableView,QHeaderView,QVBoxLayout,QMessageBox
...
class DataGrid(QWidget):
    def __init__(self, parent=None):
        ...
        #self.setStyleSheet("background-image:url(./images/screen.png)")
        self.resize(750,300)
    ...
    def closeEvent(self, QCloseEvent):
        # 关闭数据库
        self.db.close()
        reply = QMessageBox.question(self, '消息提醒', '确认退出?', QMessageBox.Yes | QMessageBox.No, QMessageBox.No)
